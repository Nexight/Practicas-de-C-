...
*/
#endregion
#region Ejercicio: Completar el deasfio de aplicar la interpolación de cadenas a una carta de formulario
...
string comparisonMessage = $"{currentProduct.PadRight(currentProduct.Length + 9)} {currentReturn:P2}\t{currentProfit:C2}\n"
                           +$"{newProduct.PadRight(currentProduct.Length + 9)} {newReturn:P2}\t{newProfit:C2}\n";
